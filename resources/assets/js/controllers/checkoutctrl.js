angular.module('besafe')
        ...
        .controller('CheckoutCartCtrl',['$scope', '$rootScope', 'Users', 'Checkout', 'Products', '$window', function ($scope, $rootScope, Users, Checkout, Products, $window) {
            $scope.data = {};
        ...
        .controller('CheckoutShippingCtrl',['$scope', '$rootScope', 'LocationService', 'Users', 'Checkout', 'Products', '$window', function ($scope, $rootScope, LocationService, Users, Checkout, Products, $window) {
            $scope.data = {};
        ...
        .controller('CheckoutBillingCtrl',['$scope', '$rootScope', 'LocationService', 'Users', 'Checkout', 'Payu', '$window', function ($scope, $rootScope, LocationService, Users, Checkout, Payu, $window) {
            $scope.data = {};
            $scope.data2 = {};
            $scope.data3 = {};
            $scope.data4 = {};
