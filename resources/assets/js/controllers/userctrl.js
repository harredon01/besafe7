angular.module('besafe')
        ...
        .controller('UserAddressesCtrl',['$scope', 'LocationService', 'Users', function ($scope, LocationService, Users) {
            $scope.data = {};
            $scope.addresses;
            ...
            $scope.editAddress = function (address_id) {
                ...
                $scope.data.type = angular.element(document.querySelector('li#address-' + address_id + ' span.type')).html();
...
}]).controller('UserProfileCtrl',['$scope', 'LocationService', 'Users', function ($scope, LocationService, Users) {
    $scope.data = {};
    $scope.addresses;
    $scope.regionVisible = false;
    $scope.cityVisible = false;
    ...
    $scope.save = function (isvalid) {
        ...
        if (isvalid) {
            ...
            Users.saveUser($.param($scope.data)).then(function (data) {
                $scope.submitted = false;
            },
                    function (data) {
