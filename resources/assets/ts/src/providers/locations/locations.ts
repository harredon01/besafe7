...
export class Locations {
    ...
    constructor(private api: Api, private database: DatabaseService, private storage: Storage) {}
    ...
    getReportsMerchantsLocations(latit: any, longit: any, radius: any) {
        ...
        let seq = this.api.get(endpoint, data).share();
        seq.subscribe((data: any) => {
            console.log("after get locations");
            console.log(JSON.stringify(data));
            return data;
