        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="contact_message content">
                    ...
                    <p>Si deseas que se elimine tu cuenta y todos los datos asociados porfavor llena el siguiente formulario. Debes enviar el celular y el correo asociados a la cuenta y luego responder a una verificacion por medio del medio que te contactamos. Posterior a eso seras eliminado de Lonchis. Muchas gracias</p>          
                </div> 
            </div>
            <div class="col-lg-6 col-md-6">
