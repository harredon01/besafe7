            ...
            <table >
                <tbody id="route-@{{ route.id}}-table">
                    ...
                    <tr ng-repeat="stop in route.stops" data-route="@{{ stop.route_id}}" data-stop="@{{ stop.id}}">
                        ...
                        <td ng-show="stop.amount>0"><button ng-click="sendStopToNewRoute(stop.id)">Nueva Ruta</button></td>
                        <td ng-hide="stop.amount>0"><button ng-click="deleteStop(stop.id)">Borrar parada</button></td>
                    </tr>
                </tbody>
            </table>
            <table >
