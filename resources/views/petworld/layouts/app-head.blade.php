<meta charset="utf-8">
        ...
        <link rel="preload" href="/css/app.css?v=1.0.0.2" as="style" onload="this.onload=null;this.rel='stylesheet'">
        <link href="/css/style.css?v=1.0.0.2" rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'">
        <link href="/css/plugins.css?v=1.0.0.2" rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'">
        <link rel="preload" href="/css/main.css?v=1.0.0.2" as="style" onload="this.onload=null;this.rel='stylesheet'">
        ...
        <noscript>
            <link rel="stylesheet" href="/css/app.css?v=1.0.0.2">
            <link href="/css/style.css?v=1.0.0.2" rel="stylesheet">
            <link rel="stylesheet" href="/css/plugins.css?v=1.0.0.2" />
            <link rel="stylesheet" href="/css/main.css?v=1.0.0.2" />
            <link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/angular_material/1.1.0/angular-material.min.css">
        </noscript>
        
        
        <script src="/js/app.js?v=1.0.0.2"></script>
