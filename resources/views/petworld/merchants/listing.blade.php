                                                ...
                                                <div class="product-flex" ng-show="merchant.activeCategory.tots">
                                                    <div class="col-lg-4 col-sm-12" ng-repeat="product in merchant.activeCategory.featured">
                                                        <div class="" id="prod-cont-@{{product.id}}">
                                                            <a href="/a/product-detail/@{{product.slug}}?merchant_id=@{{product.merchant_id}}" class="image" tabindex="0" style="text-align: center;">
                                                                <img ng-src="@{{product.file}}">
                                                            </a>
                                                            <div class="content">
                                                                <h3 class="font-weight-500"><a href="/a/product-detail/@{{product.slug}}?merchant_id=@{{product.merchant_id}}" class="ng-binding">@{{product.name}}</a></h3>
