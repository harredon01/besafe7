...
<form class="form-horizontal" role="form" name="myFormStripe" ng-submit="save(myFormStripe.$valid)" novalidate>
    <input type="hidden" name="_token" value="{{ csrf_token()}}">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <span style="color:red" ng-show="(myFormStripe.source.$dirty && myFormStripe.source.$invalid) || submitted && myFormStripe.source.$invalid">
                <span ng-show="submitted && myFormStripe.source.$error.required">Porfavor ingresa un metodo de pago</span>
        </div>
    </div>
