...
<div>
    <ul>
        ...
        <li id="source-@{{ source.id }}" ng-repeat="source in sources">
            ...
            <br ng-hide="source.is_default || buying"/><a href="javascript:;" ng-click="setAsDefault(source)" ng-hide="source.is_default || buying" class="editar">Set as Default</a>
            <br ng-hide="source.is_default || buying"/><a href="javascript:;" ng-click="deleteSource(source)" ng-hide="source.is_default || buying" class="editar">Delete</a>
            <br ng-show="buying"/><a href="javascript:;" ng-click="selectSource(source)" ng-show="buying"class="editar">Use</a>
        </li>
